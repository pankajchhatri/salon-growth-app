...
import { Scissors, Lock, Mail, User, ShieldAlert, Sparkles, Building } from 'lucide-react'
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 -left-4 w-96 h-96 bg-purple-900/30 rounded-full blur-3xl opacity-60" />
      <div className="absolute bottom-0 right-4 w-96 h-96 bg-indigo-900/30 rounded-full blur-3xl opacity-60 animate-pulse" />
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 py-8 px-4 shadow-2xl rounded-3xl sm:px-10">
          ...
          <form action={formAction} className="space-y-5">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3 bg-slate-950/80 p-1 rounded-xl border border-slate-800">
                <button
                  type="button"
            ...
            {role === 'owner' && (
              <div>
                <label htmlFor="salonName" className="block text-sm font-medium text-slate-300">
                  Salon / Branch Name
                </label>
                <div className="mt-1 relative rounded-xl shadow-sm">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-500">
                  ...
                  <input
                    ...
                    type="text"
                    required={role === 'owner'}
                    placeholder="Enrich Salon (Bandra)"
                    className="block w-full pl-10 pr-3 py-2 bg-slate-950/60 border border-slate-800 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 transition-all text-sm"
                  />
                </div>
              </div>
